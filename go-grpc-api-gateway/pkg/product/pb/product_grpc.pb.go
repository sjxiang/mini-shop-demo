...
const (
	ProductService_CreatePorduct_FullMethodName = "/product.ProductService/CreatePorduct"
...
type ProductServiceClient interface {
	CreatePorduct(ctx context.Context, in *CreateProductRequest, opts ...grpc.CallOption) (*CreateProductResponse, error)
...
func (c *productServiceClient) CreatePorduct(ctx context.Context, in *CreateProductRequest, opts ...grpc.CallOption) (*CreateProductResponse, error) {
	out := new(CreateProductResponse)
	err := c.cc.Invoke(ctx, ProductService_CreatePorduct_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProductServiceServer interface {
	CreatePorduct(context.Context, *CreateProductRequest) (*CreateProductResponse, error)
...
func (UnimplementedProductServiceServer) CreatePorduct(context.Context, *CreateProductRequest) (*CreateProductResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreatePorduct not implemented")
}
...
func _ProductService_CreatePorduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateProductRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProductServiceServer).CreatePorduct(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProductService_CreatePorduct_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).CreatePorduct(ctx, req.(*CreateProductRequest))
	}
...
var ProductService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "CreatePorduct",
			Handler:    _ProductService_CreatePorduct_Handler,
		},
		{
			MethodName: "FindOne",
